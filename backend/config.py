...
Aturan khusus untuk indikator kecurangan:
...
_DEFAULT_RUNTIME_CONFIG: Dict[str, Any] = {
    ...
    "retention_days": 7,
    "mqtt_enabled": True,
    "mqtt_broker_host": "72.60.78.162",
    "mqtt_broker_port": 1883,
    "mqtt_topic": "voiceguard/fraud/alerts",
    "mqtt_client_id": "voiceguard-fraud-detector",
    "mqtt_username": "protequbeai",
    "mqtt_password": "@Qualita2025",
    "mqtt_use_tls": False,
    "mqtt_qos": 1,
    # Groq & LLM / STT Models
    "groq_api_key": "",
    ...
    "snapshot_upload_id_path": "data.id",
